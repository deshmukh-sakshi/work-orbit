...
import { LoadingState, ErrorState } from "@/features/profile/components/loading-error-state";
...
const FreelancerProfile: React.FC<FreelancerProfileProps> = ({ freelancerId, authToken }) => {
  const {
    data: freelancerData,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/40 py-8">
      <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header Section */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-slate-900 mb-2">Freelancer Profile</h1>
          <p className="text-slate-600">View freelancer's profile information and portfolio</p>
        </div>
